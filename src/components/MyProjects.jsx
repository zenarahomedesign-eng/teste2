  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Projetos que você está trabalhando</p>
      </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-900">Minha Função:</span>
                  </div>
